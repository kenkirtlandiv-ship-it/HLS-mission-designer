...
st.markdown("""
    ...
    /* SHIP IMAGE SCALING */
    /* Tanker and HLS restricted to standard width */
    [data-testid="column"]:nth-of-type(1) [data-testid="stImage"] img,
    [data-testid="column"]:nth-of-type(2) [data-testid="stImage"] img {
        height: 160px !important;
        width: 80px !important; /* Standard width */
        object-fit: contain;
        margin: 0 auto !important;
        display: block;
    }
    
    /* Orion forced to 2x width (160px) */
    [data-testid="column"]:nth-of-type(3) [data-testid="stImage"] img {
        height: 160px !important;
...
def get_log():
    ...
    # 2. Logic Gate: Identify Origin Orbit
    ...
    # If HLS did a push, the Orion mass is dropped at the rendezvous point in forward time, 
    # but we accounted for it in step 2. We must ensure Propellant only counts HLS burn.
