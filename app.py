...
st.markdown("""
    ...
    /* 5. BUTTON GRID (SELECTED/UNSELECTED) */
    .stButton > button {
        width: 100%;
        border: 1px solid #98FF98 !important;
...
# --- TOP HEADER ---
st.markdown("<h2 style='text-align: center; letter-spacing: 5px; margin-top: 0px;'>HLS MISSION LOGISTICS CONSOLE</h2>", unsafe_allow_html=True)
...
# PANEL 1: TANKER
with col1:
    st.markdown("""<div class='panel-container'><div class='panel-header'>STARSHIP REFILL TANKER</div><div class='panel-content'>""", unsafe_allow_html=True)
...
# PANEL 2: HLS
with col2:
    st.markdown("""<div class='panel-container'><div class='panel-header'>HLS STARSHIP</div><div class='panel-content'>""", unsafe_allow_html=True)
    inner_c3, inner_c4 = st.columns([1, 3])
    with inner_c3:
...
# PANEL 3: ORION
with col3:
    st.markdown("""<div class='panel-container'><div class='panel-header'>ORION MODE</div><div class='panel-content'>""", unsafe_allow_html=True)
    inner_c5, inner_c6 = st.columns([1, 3])
    with inner_c5:
...
# --- RESULTS ---
st.markdown("<h3 style='margin-bottom:0px;'>RESULTS</h3>", unsafe_allow_html=True)
...
for i in range(min(tanks, 15)):
    with t_cols[i]: st.image("tanker.svg", use_container_width=True)
